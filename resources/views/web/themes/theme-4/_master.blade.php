...
<head>
    ...
    <!-- Demo CSS -->
    <link rel="stylesheet" href="{{ mix('/frontend/css/themes/theme-4.css') }}">

    <!-- Skin CSS -->
    <link rel="stylesheet" href="{{ mix('/frontend/css/skins/theme-4-'.$site->skin.'.css') }}">
...
<body>
    <div class="body">
        ...
        @include('web.themes.theme-4._partials.header')
        <div role="main" class="main">

            @yield('content')

        </div>
        @include('web.themes.theme-4._partials.footer')
