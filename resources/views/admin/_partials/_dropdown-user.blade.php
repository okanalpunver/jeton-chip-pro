...
<div class="kt-notification">
    ...
    <div class="kt-notification__custom kt-space-between"> 
        <a class="btn btn-label btn-label-primary btn-sm btn-bold" href="{{ route('admin.logout') }}"
        ...
        {{-- <a href="?page=custom/user/login-v2" target="_blank" class="btn btn-clean btn-sm btn-bold">Upgrade Plan</a>  --}}
    </div>
</div>
<!--end: Navigation -->